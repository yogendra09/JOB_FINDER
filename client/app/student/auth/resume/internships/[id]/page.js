...
const page = ({params}) => {
  ...
  const EditInternHandler = (e) => {
    ...
    dispatch(asynceditinternstudent(params.id,internship));
  };

  return (
    <div>

    <h1 className="text-2xl font-normal ml-10 mt-5">Edit <span className="text-blue-600 ">Internship</span></h1>

     <div className="p-10">
       <form  onSubmit={EditInternHandler}>
