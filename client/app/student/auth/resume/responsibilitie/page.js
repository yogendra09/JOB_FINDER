"use client"
import { asyncaddresponsetudent } from "@/store/Actions/studentActions";
...
const page = () => {
  ...
  const AddResHandler = (e) => {
    ...
    dispatch(asyncaddresponsetudent(res));
...
<h1 className="text-2xl font-normal ml-10 mt-5">Add <span className="text-blue-600 ">Responsiblitie</span></h1>

  <div className="p-10">
    <form  onSubmit={AddResHandler}>
