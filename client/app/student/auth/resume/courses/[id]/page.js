"use client"
import { asynceditcoursetudent } from "@/store/Actions/studentActions";
...
const page = ({params}) => {
  ...
  await  dispatch(asynceditcoursetudent(params.id,course));
  ...
  return (
    ...
    <h1 className="text-2xl font-normal ml-10 mt-5">Edit <span className="text-blue-600 ">Course</span></h1>
