"use client"
import { asynceditaccomptudent } from "@/store/Actions/studentActions";
...
const page = ({params}) => {
  ...
  const EditaccompHandler = async(e) => {
    e.preventDefault()
    const accomp = {
       discription
    };
    await dispatch(asynceditaccomptudent(params.id,accomp));
  ...
  return (
    ...
    <h1 className="text-2xl font-normal ml-10 mt-5">Edit <span className="text-blue-600 ">Accomplishments</span></h1>
