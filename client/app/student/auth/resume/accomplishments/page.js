"use client"
import { asyncaddaccomptudent } from "@/store/Actions/studentActions";
...
const page = () => {
  ...
  const AddAccompHandler = async() => {
    const accomp = {
      discription
    };

   await dispatch(asyncaddaccomptudent(accomp));
  ...
  return (
    ...
    <h1 className="text-2xl font-normal ml-10 mt-5">Add <span className="text-blue-600 ">Accomplishments</span></h1>
